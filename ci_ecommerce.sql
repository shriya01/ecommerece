...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Stores order related information' AUTO_INCREMENT=19 ;
-- --------------------------------------------------------
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Stores payment method related information' AUTO_INCREMENT=7 ;
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `user_country` varchar(21) NOT NULL,
  `user_city` varchar(21) NOT NULL,
  `user_state` varchar(21) NOT NULL,
...
ALTER TABLE `order`
  ...
  ADD CONSTRAINT `order_ibfk_3` FOREIGN KEY (`payment_method_id`) REFERENCES `payment_method` (`payment_method_id`);
