...
<html>
    ...
    <body>
        <div id="bill_info">
            ...
            <form name="billing" method="post" action="<?php echo base_url() . 'index.php/product/save_order' ?>" >
                ...
                <div align="center">
                    ...
                    <table border="0" cellpadding="2px">
                        ...
                        echo "<a class ='fg-button teal' id='back' href=" . base_url() . "index.php/product>Back</a>";  ?>
