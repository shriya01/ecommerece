  ...
  <div class="table-responsive">
   ...
   foreach($product as $row)
   {
    ...
    <div class="col-md-4" style="padding:16px; background-color:#f1f1f1; border:1px solid #ccc; margin-bottom:16px; height:400px" align="center">
     ...
     <img src="'.base_url().'uploads/'.$row->product_image.'" class="img-thumbnail" /><br />
     ...
     <button type="button" name="add_cart" class="btn btn-success add_cart" data-product_name="'.$row->product_name.'" data-price="'.$row->product_price.'" data-product_id="'.$row->product_id.'" />Add to Cart</button>
    </div>
    ';
   }
   ?>
